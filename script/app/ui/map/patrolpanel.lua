...
function PatrolUI:init()
    ...
    goldImg:loadTexture('uires/ui/res/gold.png')
    ...
    self.spineAni1 = GlobalApi:createArmature("daobing_1_r", "animation/daobing_1_r/daobing_1_r", "animation_littlelossy/xiaobing/xiaobing", 1)
