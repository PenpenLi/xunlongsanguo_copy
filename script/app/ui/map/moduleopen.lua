...
function ModuleOpenUI:init()
    ...
    contentImg:loadTexture("uires/ui/moduleopen/" .. conf.contentRes)
    contentImg:ignoreContentAdaptWithSize(true)
    contentImg:setTouchEnabled(true)
    titleImg:setVisible(false)
    -- titleImg:loadTexture("uires/ui/moduleopen/" .. conf.titleRes)
    -- titleImg:ignoreContentAdaptWithSize(true)
    local richText = xx.RichText:create()
    richText:setAlignment('middle')
    richText:setVerticalAlignment('middle')
    richText:setContentSize(cc.size(500, 40))
    local rt = xx.RichTextImage:create("uires/ui/moduleopen/" .. conf.titleRes)
    local rt1 = xx.RichTextImage:create('uires/ui/moduleopen/dian.png')
    local rt2 = xx.RichTextImage:create('uires/ui/moduleopen/open.png')
