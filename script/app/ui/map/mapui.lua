...
function MainSceneUI:createBtns()
    ...
    local backBtn = ccui.Button:create('uires/ui/mainscene/hc_nor_btn.png','uires/ui/mainscene/hc_sel_btn.png')
    local changeBtn = ccui.Button:create('uires/ui/mainscene/jingying.png')
    local legionCityBtn = ccui.Button:create('uires/ui/mainscene/territory_nor_btn.png','uires/ui/mainscene/territory_sel_btn.png')
    ...
    maopaoBg:setPosition(cc.p(backBtn:getContentSize().width/2,backBtn:getContentSize().height*2))
    ...
    maopaoTx:setPosition(cc.p(backBtn:getContentSize().width/2,backBtn:getContentSize().height*2+8))
    ...
    backBtn:setPosition(cc.p(size.width/2,size.height/2))
