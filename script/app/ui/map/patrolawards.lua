...
function PatrolAwardsUI:updatePanel()
    ...
    local function createCell(q,name,num)
        ...
        bgImg:loadTexture('uires/ui/expedition/equip_'..q..'.png')
...
function PatrolAwardsUI:init()
    ...
    local re1 = xx.RichTextLabel:create('', 30, COLOR_TYPE.WHITE)
    local re2 = xx.RichTextLabel:create(GlobalApi:getLocalStr('STR_HOUR'), 30, COLOR_TYPE.WHITE)
    re2:setFont('font/gamefont1.TTF')
    local re3 = xx.RichTextLabel:create('', 30, COLOR_TYPE.WHITE)
    local re4 = xx.RichTextLabel:create(GlobalApi:getLocalStr('STR_MINUTE'), 30, COLOR_TYPE.WHITE)
    re4:setFont('font/gamefont1.TTF')
    local re5 = xx.RichTextLabel:create('', 30, COLOR_TYPE.WHITE)
    local re6 = xx.RichTextLabel:create(GlobalApi:getLocalStr('STR_SECOND'), 30, COLOR_TYPE.WHITE)
    re6:setFont('font/gamefont1.TTF')
    ...
    richText:setPosition(cc.p(455,301))
