...
function LegionActivityShakeUI:init()
    ...
    self.shakebtn:addTouchEventListener(function (sender, eventType)
        if eventType == ccui.TouchEventType.began then
            AudioMgr.PlayAudio(11)
        elseif eventType == ccui.TouchEventType.ended then
            self.selectAni:setAnimation(0, "idle2", false)
    ...
    desec1re1:setFont('font/gamefont1.TTF')
    ...
    desec2re1:setFont('font/gamefont1.TTF')
    ...
    desec2re3:setFont('font/gamefont1.TTF')
    ...
    desec3re1:setFont('font/gamefont1.TTF')
    ...
    desec3re3:setFont('font/gamefont1.TTF')
    ...
    self.selectAni = GlobalApi:createSpineByName("ui_legion_shake", "spine/ui_legion_shake/ui_legion_shake", 1)
    self.selectAni:setAnimation(0, "idle1", true)
    self.selectAni:setPosition(cc.p(400,180))
    self.bgimg4:addChild(self.selectAni)
    self.selectAni:registerSpineEventHandler(function (  )
        self.selectAni:setAnimation(0, 'idle1', true)
...
function LegionActivityShakeUI:goldFly()
    ...
    for i=1,num do
        ...
        local goldImg = ccui.ImageView:create('uires/ui/res/gold.png')
