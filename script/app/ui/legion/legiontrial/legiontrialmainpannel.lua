...
local CHOOSE_BTN_NORMAL = 'uires/ui/legion/legiontrial/ban6.png'
local CHOOSE_BTN_PRESS = 'uires/ui/legion/legiontrial/ban5.png'

local WENHAO_IMG = 'uires/ui/legion/legiontrial/wenhao.png'

local GUAIREN_IMG = 'uires/ui/legion/legiontrial/guairen2.png'
local SHANGREN_IMG = 'uires/ui/legion/legiontrial/shangren2.png'
local TOUMING_IMG = 'uires/ui/common/touming.png'

local MAXLOCAL_ZORDER = 10000
local ADVERNTRUE_ZORDER = 1

local BOX_IMG = 'uires/ui/legion/legiontrial/box17.png'
...
function LegionTrialMainPannelUI:startRunAction()
    ...
    elseif self.legionTrialAdventureType == LEGION_TRIAL_ADVENTURE_TYPE.CASH then
        ...
        local name = 'trial_monster'
        local idleName = 'idle_in'
        local aniMoveImg = GUAIREN_IMG
        local aniName = 'shengli'
        if self.legionTrialAdventureType == LEGION_TRIAL_ADVENTURE_TYPE.SHOP then
            name = 'shop'
            idleName = 'idle_in'
            aniMoveImg = SHANGREN_IMG
            aniName = 'shengli'
        else
            name = 'trial_monster'
            idleName = 'idle2'
            aniMoveImg = GUAIREN_IMG
            aniName = 'skill1'
        end

        local spine = GlobalApi:createSpineByName(name, "spine/city_building/" .. name, 1)
        spine:setScale(-0.6,0.6)
        spine:setPosition(self.initStartPos)
        self.trialImg:addChild(spine)
        spine:setAnimation(0, idleName, true)
