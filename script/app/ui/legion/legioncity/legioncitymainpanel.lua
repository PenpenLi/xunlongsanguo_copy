...
function LegionCityMainUI:update()
    ...
    if selfpage < 4 then
        self.areaimg:loadTexture('uires/ui/legion/area_'..selfpage..'_img.png')
        self.areanumtx:setString('1')
    else
        self.areaimg:loadTexture('uires/ui/legion/area_4_img.png')
    ...
    for i=1,7 do
        ...
        if (selfpage-1)*7+i <= #self.memberarr  then
            ...
            local img = ccui.ImageView:create('uires/ui/legion/city_bg.png')
            self.cityarr[i].funcbtn:loadTextureNormal('uires/ui/legion/city_bg.png')
