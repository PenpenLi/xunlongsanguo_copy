...
function LegionWarMainUI:update()
    ...
    if rankid+1 >= #rankconf then      
        ...
        self.nextrankingimg:loadTexture("uires/ui/legionwar/".. tostring(rankconf[rankid].icon))
    else
        self.nextrankingimg:loadTexture("uires/ui/legionwar/".. tostring(rankconf[rankid+1].icon))
    ...
    if self.wardata.joined  and self.wardata.stage == 2 then
        ...
        self.battlelegionflagimg2:loadTexture('uires/ui/legion/'..enemylegionwardata.icon..'_jun.png')
