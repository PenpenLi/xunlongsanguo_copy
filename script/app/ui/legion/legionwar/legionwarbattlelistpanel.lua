...
function LegionWarBattleListUI:addCells(index,celldata)
    ...
    legionflag1:loadTexture('uires/ui/legion/'..celldata[2].own.icon..'_jun.png')
    local legionflag2 = bluebg:getChildByName('legion_flag_2_img')
    legionflag2:loadTexture('uires/ui/legion/'..celldata[2].enemy.icon..'_jun.png')
    ...
    if celldata[2].own.win == true then
        wlimg:loadTexture('uires/ui/worldwar/red_victory.png')
    else
        wlimg:loadTexture('uires/ui/legionwar/bai.png')
    end
