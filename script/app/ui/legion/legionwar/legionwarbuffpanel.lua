...
cc.exports.LEGIONCARD_ITEMFRAME = {
    ['blue'] = "uires/ui/legionwar/card_blue.png",
    ['purple'] = "uires/ui/legionwar/card_purple.png",
    ['orange'] = "uires/ui/legionwar/card_yellow.png"
}
...
function LegionWarBuffUI:update()
    ...
    for i=1,7 do
        ...
        self.cardarr[i].iconimg:loadTexture('uires/ui/legionwar/'..cardeffectconf[i].icon)
    ...
    self.maincard.iconimg:loadTexture('uires/ui/legionwar/'..cardeffectconf[self.selectid].icon)
