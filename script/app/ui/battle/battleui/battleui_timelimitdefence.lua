...
function BattleTimeLimitDefenceUI:initExtraUI()
    ...
    local descLabel = cc.Label:createWithTTF(GlobalApi:getLocalStr("GET_WIN_AFTER_SEVERAL_ATTACK"), "font/gamefont1.TTF", 25)
    ...
    local remainRoundLabel = cc.Label:createWithTTF("", "font/gamefont1.TTF", 25)
