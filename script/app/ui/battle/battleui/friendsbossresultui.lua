...
function FriendsBossResultUI:ctor(damage, score, displayAwards, starNum, specialAwardDatas, kingLvUpData)
...
function FriendsBossResultUI:init()
    ...
    damageNameTx:setFontName("font/gamefont1.TTF")
    ...
    scoreNameTx:setFontName("font/gamefont1.TTF")
