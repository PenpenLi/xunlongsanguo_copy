    ...
    for i = 1, 4 do
        ...
        title:addTouchEventListener(function (sender, eventType)
            ...
            elseif eventType == ccui.TouchEventType.canceled then
                title:loadTexture("uires/ui/worldwar/feats_wall_bg.png")
            end
        end)
    end
end
...
function TotalBattleReportUI:changePage(page)
    ...
    if self.currPage > 0 then
        ...
        self.titles[self.currPage]:loadTexture("uires/ui/worldwar/feats_wall_bg.png")
    end
...
function TotalBattleReportUI:updateWorldWarCell(cellType, index, data)
    ...
    if data.win then
        cell.isWin:loadTexture("uires/ui/report/win.png")
    else
        cell.isWin:loadTexture("uires/ui/report/lose.png")
    end
...
function TotalBattleReportUI:updateCommendCell(cellType, index, rank, data)
    ...
    if rank <= 3 then
        ...
        cell.headpic:loadTexture("uires/ui/report/rank_" .. rank .. ".png")
    else
        cell.headpicBg:loadTexture(COLOR_FRAME[1])
        cell.headpic:loadTexture("uires/ui/report/rank_0.png")
    end
...
function TotalBattleReportUI:createCellTypeTwo(index)
    ...
    local isEnemy = ccui.ImageView:create("uires/ui/report/is_enemy.png")
    ...
    local vImg = ccui.ImageView:create("uires/ui/chat/vip_small.png")
