...
function TavernLimitAwardUI:init()
    ...
    self:refresh()
    self:adaptUI(bgimg,bgAlpha,true)
...
function TavernLimitAwardUI:refresh()
    ...
    for i = 1,MAXNUM do
        ...
        if self.awards[i][1] == 'card' then
            ...
            :loadTexture('uires/ui/strength/light_bg.png')
        ...
        if frame.cell == nil then
            ...
            local name = cc.Label:createWithTTF('', 'font/gamefont1.TTF', 22)
    ...
    if self.type == 'love' then
        ...
        yuanbaoImg:loadTexture('uires/ui/res/love.png')
    else
