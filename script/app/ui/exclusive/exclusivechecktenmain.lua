...
function ExclusiveCheckTenMainUI:init()
    ...
    closeBtn:setPosition(cc.p(winSize.width + 5,winSize.height + 12))
...
function ExclusiveCheckTenMainUI:updateVipCount()
	...
	local re1 = xx.RichTextLabel:create(GlobalApi:getLocalStr('EXCLUSIVE_DESC_87') .. desc, 28, COLOR_TYPE.WHITE)
...
function ExclusiveCheckTenMainUI:updateOneExclusive()
    ...
    pl:loadTexture('uires/ui/exclusive/22.png')
    trvernIcon:loadTexture('uires/ui/exclusive/tubiao2.png')
    local color = cc.c4b(58,205,248,255)
    if self.type == 3 then
        text1 = GlobalApi:getLocalStr('EXCLUSIVE_DESC_80')
        pl:loadTexture('uires/ui/exclusive/33.png')
        trvernIcon:loadTexture('uires/ui/exclusive/tubiao3.png')
	...
	local re1 = xx.RichTextLabel:create(text1, 32, color)
...
function ExclusiveCheckTenMainUI:updateTenExclusive()
	...
	richText3:setPosition(cc.p(257/2,130))
