...
local CHOOSE_BTN_NORMAL = 'uires/ui/chat/anniu4.png'
local CHOOSE_BTN_PRESS = 'uires/ui/chat/anniu3.png'

local LEGION_JIARU_BTN = 'uires/ui/chat/jiaru.png'
local LEGION_SHENGQING_BTN = 'uires/ui/chat/shenqing.png'
local LEGION_YISHENGQING_BTN = 'uires/ui/chat/yishenqing.png'
local LEGION_CHEXIAO_BTN = 'uires/ui/chat/chexiao.png'
...
function ChatNewUI:switchVoiceState()
    ...
    if self.isVoice then    -- 语音状态
        self.swithBtn:loadTextureNormal("uires/ui/friends/keyboard.png")
        self.chatLimit:setVisible(false)
    else
        self.swithBtn:loadTextureNormal("uires/ui/friends/siri.png")
...
function ChatNewUI:refreshMenus()
    for i = 1,#self.menuBtns do
        ...
        if btn.index == self.curChannelIndex then
            ...
            btn.text:setColor(cc.c4b(207,186,141,255))
            ...
            if chatData.info == nil then
                ...
                if chatData.info.roomId then    -- 合璧
                    ...
                    if(chatData.info.used and chatData.info.used ~= 0) then     --  已经使用
                        ...
                        getBtn:loadTextureNormal("uires/ui/chat/yilingqu.png")
                    else
                        getBtn:setTouchEnabled(true)
                        getBtn:loadTextureNormal("uires/ui/chat/lingqu.png")
