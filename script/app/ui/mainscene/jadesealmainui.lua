...
local defaultNor = {  
    [1] = 'uires/ui/rankinglist_v3/huangcheng1.png',
    [2] = 'uires/ui/rankinglist_v3/shenjiang1.png',
}

local defaultSel = {
    
    [1] = 'uires/ui/rankinglist_v3/huangcheng2.png',
    [2] = 'uires/ui/rankinglist_v3/shenjiang2.png',
}
...
function JadesealUI:setListItem( index)
    ...
    iconimg:loadTexture('uires/ui/jadeseal/'..data.jadesealicon)
...
function JadesealUI:updateJadesealPl()
    ...
    funcbtn:addTouchEventListener(function (sender, eventType)
        ...
        elseif eventType == ccui.TouchEventType.ended then
            ...
            --     --print(RoleData:getMainRole():getId())
            --     RoleMgr:showStengthenPopupUI(RoleData:getMainRole(), 'upgrade_junzhu', curatt,nowatt , function ()
            --         MainSceneMgr:showJadesealGetAwardUI(self.selectid)
            --         self:update()
            --     end)
            -- else
            --     img:setRotation(-45)
            --     img:setPosition(cc.p(29,-300))
            --     img:setVisible(true)
            --     img:setScale(2.0)
    ...
    if tonumber(conf.unlock) and tonumber(conf.unlock) >1000 then
        ...
        if spineAni then
            ...
            spineAni:setPosition(cc.p(55,35+ obj:getUiOffsetY()))
        ...
        if spineAni2 then
            ...
            spineAni2:setPosition(cc.p(55,35+ obj:getUiOffsetY()))
        ...
        funcimg:loadTexture('uires/ui/jadeseal/'..conf.funcicon)
        local richText = xx.RichText:create()
        richText:setContentSize(cc.size(176, 33))
...
function JadesealUI:godsetListItem( index)
    ...
    if self.herotab[index+1][2] == 1 then   
        ...
        heroimg:loadTexture('uires/ui/jadeseal/hero.png')
    end
    numbertx:removeAllChildren()
    numbertx:setString('')
    local numtx = cc.LabelAtlas:_create('', "uires/ui/number/number1.png", 16, 22, string.byte('-'))
