...
function CountryWarListUI:updateCampPanel()
    ...
    for i = 1, 3 do
	    ...
	    rankImg:loadTexture("uires/ui/rankinglist_v3/rank_" .. self.data.campRankList[i].rank .. ".png")
	    local flag1 = city:getChildByName("flag_1")
	    flag1:ignoreContentAdaptWithSize(true)
	    flag1:loadTexture("uires/ui/countrywar/flag_" .. self.data.campRankList[i].country ..  ".png")
	    local flag2 = city:getChildByName("flag_2")
	    flag2:ignoreContentAdaptWithSize(true)
	    flag2:loadTexture("uires/ui/country/flag_" .. self.data.campRankList[i].country .. "_" .. self.data.campRankList[i].country .. ".png")
...
function CountryWarListUI:updateMyInfo()
    ...
    elseif rank <= 3 then
        ...
        rankTx:setString('')
        rankImg:loadTexture('uires/ui/rankinglist_v3/rank_'..rank..'.png')
        rankImg:ignoreContentAdaptWithSize(true)
    else
        posTx:setString('')
        rankImg:setVisible(false)
...
function CountryWarListUI:updateListPanel(data)
	...
	for i=1,maxCell do
        ...
        if i <= 3 then
            rankImg:setVisible(true)
            rankTx:setString('')
            rankImg:loadTexture('uires/ui/rankinglist_v3/rank_'..i..'.png')
            rankImg:ignoreContentAdaptWithSize(true)
        else
            rankImg:setVisible(false)
            rankTx:setString(i)
