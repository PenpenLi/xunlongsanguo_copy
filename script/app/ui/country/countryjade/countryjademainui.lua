...
function CountryJadeMainUI:init()
	...
	if winSize.width <= 1024 then
		bgimg:setContentSize(winSize)
		bgimg:setPosition(cc.p(winSize.width*0.5, winSize.height*0.5))
		svBg:setPosition(cc.p(winSize.width*0.5 - 22,winSize.height/2 + 13))
		local countryImg = bgimg1:getChildByName('country_img')
		countryImg:setPosition(cc.p(svBg:getPositionX() + 450,winSize.height/2 + 13))
	else
