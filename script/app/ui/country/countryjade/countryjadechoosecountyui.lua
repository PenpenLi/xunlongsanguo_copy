...
function CountryJadeChooseCountryUI:initData()
    self.countryDatas = {
	    [1] = { ["light_img"] = 'uires/ui/country/flag_1_1.png', ["country_img"] = 'uires/ui/country/flag_1.png',["name"] = GlobalApi:getLocalStr('COUNTRY_JADE_DES13')},
	    [2] = { ["light_img"] = 'uires/ui/country/flag_2_2.png', ["country_img"] = 'uires/ui/country/flag_2.png',["name"] = GlobalApi:getLocalStr('COUNTRY_JADE_DES14')},
	    [3] = { ["light_img"] = 'uires/ui/country/flag_3_3.png', ["country_img"] = 'uires/ui/country/flag_3.png',["name"] = GlobalApi:getLocalStr('COUNTRY_JADE_DES15')},
    }
end
