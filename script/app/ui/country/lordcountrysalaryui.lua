...
function LordCountrySalaryUI:init()
    ...
    for i = 1, 3 do
	    ...
	    rank_img:loadTexture("uires/ui/rankinglist_v3/rank_" .. self.cityRank[i].rank .. ".png")
	    local flag_1 = city:getChildByName("flag_1")
	    flag_1:ignoreContentAdaptWithSize(true)
	    flag_1:loadTexture("uires/ui/country/flag_" .. self.cityRank[i].id ..  ".png")
	    local flag_2 = city:getChildByName("flag_2")
	    flag_2:ignoreContentAdaptWithSize(true)
	    flag_2:loadTexture("uires/ui/country/flag_" .. self.cityRank[i].id .. "_" .. self.cityRank[i].id .. ".png")
