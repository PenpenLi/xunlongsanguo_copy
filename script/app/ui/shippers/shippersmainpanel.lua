...
function ShippersMainUI:updateBiaoche()
    ...
    for k,v in pairs(self.data.shippers) do
        ...
        local spineAni = GlobalApi:createSpineByName(spineName, "spine/" .. spineName .. "/" .. spineName, 1)
        spineAni:setScale(0.6)
        spineAni:setPosition(cc.p(50, 0))
        spineAni:setAnimation(0, "walk", true)
        ...
        if UserData:getUserObj():getUid() == tonumber(k) then
            ...
            self.light:setPosition(cc.p(50,10))
