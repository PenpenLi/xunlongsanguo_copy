...
local function getColorBgUrl(id)
	local strBuff = ''
	if id == 1 then
		strBuff = 'uires/ui/shippers/green_card.png'
	elseif id == 2 then
		strBuff = 'uires/ui/shippers/blue_card.png'
	elseif id == 3 then
		strBuff = 'uires/ui/shippers/purple_card.png'
	elseif id == 4 then
		strBuff = 'uires/ui/shippers/orange_card.png'
	elseif id == 5 then
		strBuff = 'uires/ui/shippers/red_card.png'
	end
	return strBuff
end
