...
function ArenaAwardsCell:initCell(lastObj, obj)
    ...
    -- 排名
    local strLength = 0
    local rankLabel1 = cc.Label:createWithTTF("", "font/gamefont1.TTF", 25)
    ...
    if self.index == obj.rank then
        ...
        local rankLabel3 = cc.Label:createWithTTF("", "font/gamefont1.TTF", 25)
        ...
        local rankLabel5 = cc.Label:createWithTTF("", "font/gamefont1.TTF", 25)
