...
function ArenaChangeRankUI:init()
    ...
    local whiteImg = cardImg1:getChildByName("white_img")
    ...
    cardImg1:runAction(cc.Sequence:create(cc.DelayTime:create(0.5), bezierAction1, cc.ScaleTo:create(0.1, 1.1), cc.CallFunc:create(function ()
            ...
            whiteImg:setOpacity(0)
            whiteImg:runAction(cc.Sequence:create(cc.FadeTo:create(0.1, 150), cc.FadeOut:create(0.1)))
    ...
    cardImg2:runAction(cc.Sequence:create(cc.DelayTime:create(0.5), bezierAction2))
