...
local c = {
	...
	[3] = {
		bg_nor = 'uires/ui/rankinglist/huangtiao.png',
		bg_sel = 'uires/ui/rankinglist/zitiao.png',
		icon_nor = 'uires/ui/rankinglist/bang1.png',
		icon_sel = 'uires/ui/rankinglist/bang2.png',
		text = 'ARENA_TITLE3',
		text_nor_color = cc.c3b(0xcf, 0xba, 0x8d),
		text_nor_stroke = cc.c3b(0x4e, 0x31, 0x11),
		text_nor_stroke_size = 2,
	...
	[4] = {
		bg_nor = 'uires/ui/rankinglist/huangtiao.png',
		bg_sel = 'uires/ui/rankinglist/zitiao.png',
		icon_nor = 'uires/ui/rankinglist/zhanbao1.png',
		icon_sel = 'uires/ui/rankinglist/zhanbao2.png',
...
function ArenaV2UI:init()
	...
	self.root:getChildByName('close')
...
function ArenaV2UI:onUpdate()
	...
	self.root:getChildByName('close')
		...
		:setPosition(cc.p(winSize.width - closeIntSize.width,
			winSize.height - closeIntSize.height))
...
function ArenaV2UI:updateChallengeCount(ntype)
	...
	if levelConf[level + 1] then
		...
		local rtl1 = xx.RichTextLabel:create(
			...
			25,
			COLOR_TYPE.WHITE)
		rtl1:setFont('font/gamefont1.TTF')
		...
		local rtl3 = xx.RichTextLabel:create(
			...
			25,
			COLOR_TYPE.WHITE)
		rtl3:setFont('font/gamefont1.TTF')
	...
	local rtl11 = xx.RichTextLabel:create(
		...
		25,
		COLOR_TYPE.YELLOW)
	rtl11:setFont('font/gamefont1.TTF')
	...
	rt2:format(true)
	rt2:setContentSize(cc.size(225, 40))
