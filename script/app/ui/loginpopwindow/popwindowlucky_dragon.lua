...
function PopWindowLuckyDragonUI:init()
    ...
    local guangImg = bgImg3:getChildByName('guang_img')
    local dragon = GlobalApi:createSpineByName("ui_jinbilong", "spine/ui_jinbilong/ui_jinbilong", 1)
    dragon:setAnchorPoint(cc.p(0.5,0))
    guangImg:addChild(dragon)
    dragon:setMix("idle2", "idle", 0.5)
    dragon:setScale(0.4)
    dragon:setPosition(cc.p(658/2, 20))
