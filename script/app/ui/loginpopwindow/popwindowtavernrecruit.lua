local PopWindowTavernRecruitUI = class("PopWindowTavernRecruitUI", BaseUI)
local ClassItemCell = require('script/app/global/itemcell')

function PopWindowTavernRecruitUI:ctor(data)
    self.data = data
    self:init()
end

function PopWindowTavernRecruitUI:init()
    local node = cc.CSLoader:createNode("csb/pop_window_tavern_recruit.csb")
...
function PopWindowTavernRecruitUI:getPanel()
    return self.bgImg
end

return PopWindowTavernRecruitUI