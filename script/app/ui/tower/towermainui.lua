...
function TowerUI:init()
    ...
    self.infoTowerlabel[2] = xx.RichTextImage:create('uires/ui/res/tower.png')
    ...
    descnode:setPosition(cc.p(-winSize.width/2,winSize.height/2))
    self.descarr = {}
    for i=1,3 do
        local arr = {}
    ...
    self.autobtn:loadTextureNormal('uires/ui/tower/autofight.png')
    ...
    autobtnnode:setPosition(cc.p(80-(winSize.width-960)/2,autobtnnode:getPositionY()+(640-winSize.height)/2 - 25))
    ...
    self.inforichtext:setContentSize(cc.size(800, 40))
    self.infolabel[1] = xx.RichTextLabel:create('', 25, COLOR_TYPE.ORANGE)
    ...
    self.infolabel[3] = xx.RichTextLabel:create('', 25, COLOR_TYPE.ORANGE)
    self.infolabel[3]:setStroke(COLOROUTLINE_TYPE.BLACK, 1)
    self.infolabel[4] = xx.RichTextLabel:create('', 25, COLOR_TYPE.ORANGE)
    ...
    self.infolabel[6] = xx.RichTextLabel:create('', 25, COLOR_TYPE.ORANGE)
    self.infolabel[6]:setStroke(COLOROUTLINE_TYPE.BLACK, 1)
    self.infolabel[7] = xx.RichTextLabel:create('', 25, COLOR_TYPE.ORANGE)
    self.infolabel[7]:setStroke(COLOROUTLINE_TYPE.BLACK, 1)

    self.infolabel[8] = xx.RichTextLabel:create('', 25, COLOR_TYPE.ORANGE)
    self.infolabel[8]:setStroke(COLOROUTLINE_TYPE.BLACK, 1)
    self.infolabel[9] = xx.RichTextLabel:create('', 25, COLOR_TYPE.ORANGE)
...
function TowerUI:updatemain()
    ...
    for i=1,8 do
        ...
        self.attlabeltab[i]:setColor(COLOR_TYPE.DARK)
        self.attlabeltab[i]:enableOutline(COLOROUTLINE_TYPE.TOWERATT, 2)
    end
    ...
    for i=1,#attarr do
        ...
        self.attlabeltab[tonumber(attarr[tonumber(i)][1])]:setColor(COLOR_TYPE.PALE)
        self.attlabeltab[tonumber(attarr[tonumber(i)][1])]:enableOutline(COLOROUTLINE_TYPE.PALE, 2)
    end
