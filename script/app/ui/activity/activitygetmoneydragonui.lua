...
function ActivityGetMoneyDragonUI:init()
    ...
    for i = 1, 3 do
        ...
        local rt3 = xx.RichTextImage:create("uires/ui/res/cash.png")
        rt3:setScale(0.7)
    ...
    self.dragon = GlobalApi:createSpineByName("ui_jinbilong", "spine/ui_jinbilong/ui_jinbilong", 1)
    image:addChild(self.dragon)
    self.dragon:setMix("idle2", "idle", 0.5)
    self.dragon:setScale(0.4)
    self.dragon:setPosition(cc.p(220, 220))
    self.dragon:setAnimation(0, "idle", true)
    ...
    self.highest_img = image:getChildByName("highest_img")
    self.highest_img:setVisible(false)
    self.get_tx = self.highest_img:getChildByName("get_tx")
...
function ActivityGetMoneyDragonUI:startRunNumber(targetNumber)
    ...
    self.running = true
    self.dragon:setAnimation(0, "idle2", true)
...
function ActivityGetMoneyDragonUI:update()
    if self.lucky_dragon.use >= self.vipAllCount then
        ...
        self.highest_img:setVisible(true)
