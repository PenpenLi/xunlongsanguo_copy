...
function SignMainUI:createAward()
    ...
    local doubleImg = ccui.ImageView:create('uires/ui/sign/vip_new.png')
    doubleImg:setAnchorPoint(cc.p(0,1))
    doubleImg:setPosition(cc.p(0,size.height))

    local doubleVImg = ccui.ImageView:create('uires/ui/sign/v_img.png')
    ...
    local vipdesc = cc.Label:createWithTTF("", "font/gamefont1.TTF", 20)
    -- numtx:setScale(0.7)
