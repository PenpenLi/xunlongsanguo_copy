...
function RoleMainUI:init()
	...
	self.riseStarBtn:loadTextureNormal('uires/ui/role/flag_'..conf.quality..'.png')
	...
	probtn:setPosition(cc.p(0,winSize.height/2))
	...
	nextbtn:setPosition(cc.p(winSize.width,winSize.height/2))
	...
	self.rtname:setContentSize(cc.size(177, 37))
	self.rtname:setPositionPercent(cc.p(0.5, 0.45))
...
function RoleMainUI:setAtt()
	...
	self.name:setFont("font/gamefont1.TTF")
	self.name:setFontSize(30)
	self.strength:setFontSize(30)
