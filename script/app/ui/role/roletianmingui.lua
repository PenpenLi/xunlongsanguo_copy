...
function RoleTianmingUI:initPanel()
	...
	local needtx = self.nor_pl:getChildByName('need_tx')
...
function RoleTianmingUI:updatebar(level,energy,need,have,oldenergy )
	...
	if award:getId() == 300001 then
		self.lvbtn:loadTextureNormal('uires/ui/role/btn_tm_nor.png')
	elseif award:getId() == 300019 then
		self.lvbtn:loadTextureNormal('uires/ui/role/btn_tm_high.png')
	end
