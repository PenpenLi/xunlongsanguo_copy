...
function RoleSoldierUI:initPanel()
   ...
   -- local att2maxbg = self.attmaxbg:getChildByName('num_bg')
    ...
    for i = 1,5 do
        ...
        img:loadTexture('uires/ui/role/star_3.png')
...
function RoleSoldierUI:getStarNumAndLevel(level)
    if level <= 5 then
        local num = level
        local url = 'uires/ui/role/star_1.png'
        return num,url
    elseif level > 5 and level <= 10 then
        local num = level - 5
        local url = 'uires/ui/role/star_2.png'
        return num,url
    else
        local num = level - 10
        local url = 'uires/ui/role/star_3.png'
        return num,url
    end
...
function RoleSoldierUI:updateNorPanel(obj)
	...
	self.soldierarrbef[1]:loadTexture('uires/ui/role/' ..soldlevelconf.soldierIcon )
	self.soldierarraft[1]:loadTexture('uires/ui/role/' ..soldlevelconf1.soldierIcon )
...
function RoleSoldierUI:updateMaxPanel(obj)
	...
	self.soldiermaxarr[1]:loadTexture('uires/ui/role/' ..soldlevelconf.soldierIcon )
	-- for i=1,12 do
	-- 	self.soldiermaxarr[i]:loadTexture('uires/ui/role/' ..soldlevelconf.soldierIcon )
