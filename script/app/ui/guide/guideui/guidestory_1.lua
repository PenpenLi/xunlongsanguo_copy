...
function GuideStoryOneUI:step1()
    ...
    local function _step3()
        ...
        layout3:setBackGroundImage("uires/ui/guide/story/bg3.png")
    ...
    local function _step2()
        ...
        layout2:setBackGroundImage("uires/ui/guide/story/bg2.png")
    ...
    local function _step1()
        local textImg = ccui.ImageView:create("uires/ui/guide/story/text1.png")
        ...
        local bgArr = {}
        local bg11 = ccui.ImageView:create("uires/ui/guide/story/bg1.png")
        local bg12 = ccui.ImageView:create("uires/ui/guide/story/bg1.png")
        local bg13 = ccui.ImageView:create("uires/ui/guide/story/bg1.png")
...
function GuideStoryOneUI:step2()
    local function _step3()
        local guidetextConf = GameData:getConfData("local/guidetext")
        local bgImgSize = self.bg_img:getContentSize()
        local image = ccui.ImageView:create("uires/ui/guide/story/bg6.png")
        ...
        text2:setFontName("font/gamefont1.TTF")
    ...
    local function _step2()
        ...
        layout:setBackGroundImage("uires/ui/guide/story/bg5.png")
    ...
    local function _step1()
        ...
        local kacha = ccui.ImageView:create("uires/ui/guide/story/kacha.png")
        ...
        whiteImg:runAction(cc.Sequence:create(cc.DelayTime:create(0.5), cc.CallFunc:create(function()
            ...
            local bg1 = ccui.ImageView:create("uires/ui/guide/story/bg4.png")
            ...
            local bird = ccui.ImageView:create("uires/ui/guide/story/bird.png")
...
function GuideStoryOneUI:step3()
    local function _step2()
        local bgImgSize = self.bg_img:getContentSize()
        local image = ccui.ImageView:create("uires/ui/guide/story/bg8.png")
        local size = image:getContentSize()
        image:setAnchorPoint(cc.p(0, 0))
    ...
    local function _step1()
        ...
        local layout = ccui.Layout:create()
        layout:setBackGroundImage("uires/ui/guide/story/bg7.png")
...
function GuideStoryOneUI:step4()
    ...
    local function _step2()
        ...
        local layout = ccui.Layout:create()
        layout:setBackGroundImage("uires/ui/guide/story/bg10.png")
    ...
    local function _step1()
        ...
        local layout = ccui.Layout:create()
        layout:setBackGroundImage("uires/ui/guide/story/bg9.png")
...
function GuideStoryOneUI:step5()
    local function _step3()
        ...
        local layout = ccui.Layout:create()
        layout:setBackGroundImage("uires/ui/guide/story/bg13.png")
        ...
        blackBorder3:runAction(cc.Sequence:create(cc.MoveTo:create(0.3, cc.p(640, 200)), cc.DelayTime:create(0.5),cc.CallFunc:create(function()
            ...
            dialog:runAction(cc.Sequence:create(cc.ScaleTo:create(0.2, 1, 1), cc.DelayTime:create(3), cc.FadeOut:create(0.2), cc.DelayTime:create(0.5), cc.CallFunc:create(function()
                local finishImg = ccui.ImageView:create("uires/ui/guide/finish.png")
    ...
    local function _step2()
        ...
        local layout = ccui.Layout:create()
        layout:setBackGroundImage("uires/ui/guide/story/bg12.png")
    ...
    local function _step1()
        ...
        local layout = ccui.Layout:create()
        layout:setBackGroundImage("uires/ui/guide/story/bg11.png")
        ...
        dialogTx:setFontName("font/gamefont1.TTF")
...
function GuideStoryOneUI:createDialog(textIndex, position)
    local guidetextConf = GameData:getConfData("local/guidetext")
    local dialog = ccui.ImageView:create("uires/ui/guide/dialog_jiao2.png")
    dialog:setCascadeOpacityEnabled(true)
    dialog:setAnchorPoint(cc.p(0.5, 0))

    local dialogBG = ccui.ImageView:create("uires/ui/guide/bg_dialog4.png")
    ...
    local jiao = ccui.ImageView:create("uires/ui/guide/dialog_jiao2.png")
