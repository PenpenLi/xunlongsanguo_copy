...
function GuideStoryFourUI:step1()
    ...
    local bg = ccui.ImageView:create("uires/ui/guide/story/bg21.png")
...
function GuideStoryFourUI:step2()
    ...
    local function _step1()
        local bg = ccui.ImageView:create("uires/ui/guide/story/bg22.png")
        local size = bg:getContentSize()
...
function GuideStoryFourUI:step3()
    local function _step2()
        local bgImgSize = self.bg_img:getContentSize()
        local bg = ccui.ImageView:create("uires/ui/guide/story/bg24.png")
        local size = bg:getContentSize()
    ...
    local function _step1()
        ...
        local bg = ccui.ImageView:create("uires/ui/guide/story/bg23.png")
        local size = bg:getContentSize()
...
function GuideStoryFourUI:step4()
    ...
    local bg = ccui.ImageView:create("uires/ui/guide/story/bg25.png")
    local size = bg:getContentSize()
...
function GuideStoryFourUI:step5()
    ...
    local bg = ccui.ImageView:create("uires/ui/guide/story/bg26.png")
    local size = bg:getContentSize()
