...
function GuideStoryThreeUI:step1()
    ...
    local bg = ccui.ImageView:create("uires/ui/guide/story/bg15.png")
...
function GuideStoryThreeUI:step2()
    local function _step2()
        ...
        local bg = ccui.ImageView:create("uires/ui/guide/story/bg17.png")
    ...
    local function _step1()
        ...
        local bg = ccui.ImageView:create("uires/ui/guide/story/bg16.png")
...
function GuideStoryThreeUI:step3()
    local function _step2()
        ...
        local bg = ccui.ImageView:create("uires/ui/guide/story/bg19.png")
        local size = bg:getContentSize()
        ...
        local bg_red = ccui.ImageView:create("uires/ui/guide/story/bg19_red.png")
    ...
    local function _step1()
        ...
        local bg = ccui.ImageView:create("uires/ui/guide/story/bg18.png")
        local size = bg:getContentSize()
        layout:setContentSize(size)
        bg:setPosition(cc.p(size.width/2, size.height/2))
        layout:addChild(bg)
...
function GuideStoryThreeUI:step4()
    ...
    local bg = ccui.ImageView:create("uires/ui/guide/story/bg20.png")
    local size = bg:getContentSize()
    blackBorder:setContentSize(cc.size(size.width + 4 , size.height + 4))
    layout:setContentSize(size)
    bg:setPosition(cc.p(size.width/2, size.height/2))
    ...
    local guanyu = ccui.ImageView:create("uires/ui/guide/story/guanyu.png")
    guanyu:setPosition(cc.p(330, 210))
    layout:addChild(guanyu)

    local shanzi = ccui.ImageView:create("uires/ui/guide/story/shanzi.png")
    shanzi:setPosition(cc.p(245, 75))
    layout:addChild(shanzi)

    local zhugeliang = ccui.ImageView:create("uires/ui/guide/story/zhugeliang.png")
    zhugeliang:setPosition(cc.p(105, 100))
    layout:addChild(zhugeliang)

    local zhangfei = ccui.ImageView:create("uires/ui/guide/story/zhangfei.png")
    zhangfei:setPosition(cc.p(570, 230))
    layout:addChild(zhangfei)

    local liubei = ccui.ImageView:create("uires/ui/guide/story/liubei.png")
...
function GuideStoryThreeUI:step5()
    ...
    local zhuzi = ccui.ImageView:create("uires/ui/guide/story/zhuzi.png")
