...
local menuTree = {
	[1] = {
		bg_nor = 'uires/ui/rankinglist/huangtiao.png',
		bg_sel = 'uires/ui/rankinglist/zitiao.png',
		icon_nor = 'uires/ui/rankinglist/zhandouli1.png',
		icon_sel = 'uires/ui/rankinglist/zhandouli2.png',
	...
	[2] = {
		bg_nor = 'uires/ui/rankinglist/huangtiao.png',
		bg_sel = 'uires/ui/rankinglist/zitiao.png',
		icon_nor = 'uires/ui/rankinglist/leitai1.png',
		icon_sel = 'uires/ui/rankinglist/leitai2.png',
	...
	[3] = {
		bg_nor = 'uires/ui/rankinglist/huangtiao.png',
		bg_sel = 'uires/ui/rankinglist/zitiao.png',
		icon_nor = 'uires/ui/rankinglist/ta1.png',
		icon_sel = 'uires/ui/rankinglist/ta2.png',
	...
	[4] = {
		bg_nor = 'uires/ui/rankinglist/huangtiao.png',
		bg_sel = 'uires/ui/rankinglist/zitiao.png',
		icon_nor = 'uires/ui/rankinglist/huangcheng1.png',
		icon_sel = 'uires/ui/rankinglist/huangcheng2.png',
		...
		sub_title = {
			[1] = {
				bg_nor = 'uires/ui/rankinglist/tiao4.png',
				bg_sel = 'uires/ui/rankinglist/ban.png',
	...
	[5] = {
		bg_nor = 'uires/ui/rankinglist/huangtiao.png',
		bg_sel = 'uires/ui/rankinglist/zitiao.png',
		icon_nor = 'uires/ui/rankinglist/zhengba1.png',
		icon_sel = 'uires/ui/rankinglist/zhengba2.png',
	...
	[6] = {
		bg_nor = 'uires/ui/rankinglist/huangtiao.png',
		bg_sel = 'uires/ui/rankinglist/zitiao.png',
		icon_nor = 'uires/ui/rankinglist/juntuan1.png',
		icon_sel = 'uires/ui/rankinglist/juntuan2.png',
...
function RankingListUI:makeCityPage()
	...
	if 1 == country then
		frame:getChildByName('country'):loadTexture('uires/ui/rankinglist/wei.png')
	elseif 2 == country then
		frame:getChildByName('country'):loadTexture('uires/ui/rankinglist/shu.png')
	elseif 3 == country then
		frame:getChildByName('country'):loadTexture('uires/ui/rankinglist/wu.png')
	end
	...
	if data.position == nil then
		...
		if 1 == data.position then
			local img = xx.RichTextImage:create('uires/ui/rankinglist/crown_1.png')
		...
		elseif 2 == data.position then
			local img = xx.RichTextImage:create('uires/ui/rankinglist/crown_2.png')
		...
		elseif 3 == data.position then
			local img = xx.RichTextImage:create('uires/ui/rankinglist/crown_3.png')
	...
	while data.ranks[tostring(k)] ~= nil do
		...
		for i, v in ipairs(rankTable) do
			...
			if 1 == self.subselect then
				user:getChildByName('country'):loadTexture('uires/ui/rankinglist/wei.png')
			elseif 2 == self.subselect then
				user:getChildByName('country'):loadTexture('uires/ui/rankinglist/shu.png')
			elseif 3 == self.subselect then
				user:getChildByName('country'):loadTexture('uires/ui/rankinglist/wu.png')
			end
			local username = user:getChildByName('name')
			username:setString(v.un)
			username:enableOutline(cc.c4b(0, 0, 0, 255), 1)
