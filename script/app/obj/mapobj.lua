...
function MapObj:getBtnResource()
	-- return 'uires/ui/mainscene/city'..self.conf.type..'.png'
	return 'uires/ui/mainscene/city_'..self.conf.type..'_'..self.conf.type1..'.png'
end
...
function MapObj:getMapChipResource()
	return 'uires/ui/mainscene/'..self.conf.id..'.png'
end
